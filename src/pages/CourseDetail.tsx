        ...
        <article>
          ...
          {lesson.pdf && (
            <a
              href={lesson.pdf}
              download
              className="inline-flex items-center gap-2 font-display text-xs uppercase tracking-wide border border-indigoAccent text-indigoAccent px-3 sm:px-4 py-2 sm:py-2.5 rounded-sm hover:bg-indigoAccent hover:text-midnight transition-colors mb-8 sm:mb-10"
            >
