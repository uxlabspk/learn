    ...
    <div>
      ...
      <section className="bg-grid bg-grid border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-16">
          ...
          <h1 className="font-display font-700 text-4xl sm:text-5xl text-white leading-tight max-w-2xl">
            Learn to code, one waymarked lesson at a time.
          </h1>
          <p className="font-body text-lg text-neutral-400 mt-6 max-w-xl leading-relaxed">
          ...
          <Link
            to="/courses"
            className="inline-block mt-8 font-display text-sm uppercase tracking-wide bg-neutral-800 text-white px-6 py-3 rounded-sm hover:bg-indigoAccent hover:text-midnight transition-colors"
          >
